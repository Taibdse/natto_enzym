...
<div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
    ...
    <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default d-none">
...
-->
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
                <form>
                    ...
                    <!--begin: Head -->
                    <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(/assets/admin/assets/media/misc/bg-1.jpg)">
        ...
        <div class="kt-header__topbar-item dropdown d-none">
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                <form>
                    ...
                    <!--begin: Head -->
                    <div class="kt-head kt-head--skin-dark" style="background-image: url(/assets/admin/assets/media/misc/bg-1.jpg)">
                        <h3 class="kt-head__title">
                            User Quick Actions
        ...
        <div class="kt-header__topbar-item dropdown d-none">
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                <form>
                    ...
                    <!-- begin:: Mycart -->
                    <div class="kt-mycart">
                        <div class="kt-mycart__head kt-head" style="background-image: url(/assets/admin/assets/media/misc/bg-1.jpg);">
                            ...
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="/assets/admin/assets/media/products/product9.jpg" title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="/assets/admin/assets/media/products/product13.jpg" title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="/assets/admin/assets/media/products/product16.jpg" title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="/assets/admin/assets/media/products/product15.jpg" title="" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--quick-panel" data-toggle="kt-tooltip" title="View site" data-placement="right">
            <span class="kt-header__topbar-icon" id="kt_quick_panel_toggler_btn">
                <a href="{{ url('/') }}" target="_blank"><i class="la la-external-link" style="color: #5d78ff"></i></a>
            </span>
        </div>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                <span class="kt-header__topbar-icon">
                    <img class="" src="/assets/admin/assets/media/flags/{{  app()->getLocale() }}-flag.svg" alt="" />
                </span>
            </div>
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround">
                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                    ...
                    <li class="kt-nav__item kt-nav__item--active">
                        <a href="{{ route('admin.changLanguage', $lang->locale ) }}" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="/assets/admin/assets/media/flags/{{ $lang->locale }}-flag.svg" alt="" /></span>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    <img class="kt-hidden" alt="Pic" src="/assets/admin/assets/media/users/300_25.jpg" />
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                ...
                <!--begin: Head -->
                <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url({{ url('/') }}/assets/admin/assets/media/misc/bg-1.jpg)">
                    <div class="kt-user-card__avatar">
                        <img class="" alt="Pic" src="{{ url(Auth::user()->avatar ?? 'assets/admin/assets/media/users/default.jpg') }}" />
                        <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                ...
                <div class="kt-notification">
                    <a href="{{ route('admin.system.admin.profile') }}" class="kt-notification__item">
                        <div class="kt-notification__item-icon">
                            <i class="flaticon2-calendar-3 kt-font-success"></i>
                        </div>
                        <div class="kt-notification__item-details">
                            <div class="kt-notification__item-title kt-font-bold">
                                @lang('admin/system/admin.user_profile.myprofile')
                            </div>
                            <div class="kt-notification__item-time">
                                @lang('admin/system/admin.user_profile.acc_setting')
                            </div>
                        </div>
                    </a>
                    <div class="kt-notification__custom kt-space-between">
                        <a href="{{ route('admin.logout') }}" class="btn btn-label btn-label-brand btn-sm btn-bold">@lang('admin.common.sign_out')</a>
