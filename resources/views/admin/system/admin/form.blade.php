                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                    <div class="">
                                                        ...
                                                        <div class="d-none permission permission-group">
                                                            <div class="group">
                                                                <div class="form-group">
                                                                    <div class="kt-checkbox-list">
                                                                        @if (isset($groupRole) && count($groupRole))
                                                                            @foreach ($groupRole as $role)
                                                                                <label class="kt-checkbox kt-checkbox--tick kt-checkbox--success">
                                                                                    <input type="checkbox" name="group_role[]" value="{{ $role->id }}"> {{ $role->title }}
                                                                                    <span></span>
                                                                                </label>
                                                                            @endforeach
                                                                        @endif
...
@section('pageJs')
    <script>
        ...
        $('select[name=role_id]').on('change', function () {
            ...
            if ($value === -3) {
                $('.permission-group').removeClass('d-none');
            }
            if ($value > 0) {
