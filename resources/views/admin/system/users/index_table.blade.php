<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <th scope="col">#</th>
        <th data-field="title">@lang('admin/cms/member.tb_title')</th>
        <th data-field="image">@lang('admin/cms/member.tb_image')</th>
        <th data-field="created_at">@lang('admin/cms/member.tb_created_at')</th>
        <th data-field="status">@lang('admin/cms/member.tb_status')</th>
        <th data-field="id">@lang('admin/cms/member.tb_id')</th>
    ...
    @foreach($items as $k => $item)
        <tr>
            ...
            <td>
                @if($item->avatar)
                    <img src="{{ url($item->avatar) }}" style="height: 50px;">
                @endif
            </td>
            <td>
                {{ $item->created_at }}
