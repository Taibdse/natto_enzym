<table class="table table-hover table-striped">
    ...
    <tr>
        ...
        <th scope="col">#</th>
        <th data-field="title">@lang('admin/cms/banner.tb_title')</th>
        <th data-field="ordering">@lang('admin/cms/banner.tb_order')</th>
        <th data-field="type">@lang('admin/cms/banner.form_position')</th>
        <th data-field="image">@lang('admin/cms/banner.tb_image')</th>
        <th data-field="status">@lang('admin/cms/banner.tb_status')</th>
        <th data-field="id" width="50">@lang('admin/cms/banner.tb_id')</th>
