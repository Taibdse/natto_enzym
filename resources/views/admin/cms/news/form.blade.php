            ...
            <div class="kt-portlet">
                ...
                {!! Form::open( ['url' => ($item->id ? route($route).'/'.$item->id : route($route)), 'method' => ($item->id ? 'PATCH' : 'POST'), 'class' => 'kt-form kt-form--label-right formData', 'name'=>'formData', 'files'=>true] ) !!}
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-3 col-form-label">@lang('admin/cms/news.form_refer_date') </label>
                            <div class="col-9">
                                {!! Form::text('refer_date', $item->id ? $item->refer_date : '', ['class'=>'form-control', 'required']) !!}
                            </div>
                        </div>
                        {!! \App\Helpers\AdminHelper::getCropImageInput('Image', 'image', $item->image ?? '', false, '', '1200,630') !!}
                        {!! \App\Helpers\AdminHelper::getSelectMediaGalleryInput('Gallery', 'gallery', $item->gallery ?? '', false, '') !!}
                        ...
                        {!! \App\Helpers\AdminHelper::getTextInput('Views', 'views', $item->views ?? '100', false, '') !!}
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-9">
                                <select name="tags[]" id="tags_select2" multiple="multiple" style="width: 100%"></select>
                            </div>
                        </div>
