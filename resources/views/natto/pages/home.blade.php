...
@section('content')
    @include('natto.pages.home_banner')
    @include('natto.pages.home_online')
    @include('natto.pages.home_product')
    @include('natto.pages.product_news')
@stop

@section('footer')
    <script src="{{ url('assets/natto/js/home.js?'.config('system.version')) }}"></script>
    <script>
