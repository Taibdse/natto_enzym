...
{
    public $baseModel;
    public $route = 'admin.cms.videos_category';
    ...
    {
        $this->baseModel = new VideosCategory();

        $this->middleware('admin');

        $this->selectCategory = $this->baseModel->getCategorySelect();
    }
    ...
    public function index(Request $request)
    {
        ...
        $items = $this->baseModel->getCategoryTree(0, '', false);
